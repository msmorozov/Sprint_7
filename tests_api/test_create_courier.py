import allure
import requests
from data import ApiEndpoints, AnswersCreateCourier
...
class TestCreateCourier:
    ...
    def test_create_courier_success(self):
        ...
        assert 201 == response.status_code and AnswersCreateCourier.create_courier_success in response.text
    ...
    def test_create_courier_fail(self):
        ...
        assert 409 == response.status_code and AnswersCreateCourier.error_message_create_courier_fail in response.text
    ...
    def test_without_first_name(self):
        ...
        response = requests.post(ApiEndpoints.CREATE_COURIER, data=payload)
        assert response.status_code == 201 and AnswersCreateCourier.create_courier_success in response.text
    ...
    def test_without_login(self):
        ...
        response = requests.post(ApiEndpoints.CREATE_COURIER, data=payload)
        assert 400 == response.status_code and AnswersCreateCourier.error_message_without_login in response.text
    ...
    def test_without_password(self):
        ...
        response = requests.post(ApiEndpoints.CREATE_COURIER, data=payload)
        assert 400 == response.status_code and AnswersCreateCourier.error_message_without_password in response.text